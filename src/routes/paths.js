...
export const PATH_DASHBOARD = {
  ...
  book: {
    ...
    all: path(ROOTS_DASHBOARD, '/book/all'),
    new: path(ROOTS_DASHBOARD, '/book/new'),
    edit: (code) => path(ROOTS_DASHBOARD, `/book/${code}/edit`),
  },
  borrow: {
    root: path(ROOTS_DASHBOARD, '/borrow'),
    all: path(ROOTS_DASHBOARD, '/borrow/all'),
    new: path(ROOTS_DASHBOARD, '/borrow/new'),
    edit: (code) => path(ROOTS_DASHBOARD, `/borrow/${code}/edit`),
  },
}
