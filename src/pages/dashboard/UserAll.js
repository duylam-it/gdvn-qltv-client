...
import {
  UserTableRow,
  UserTableToolbar,
} from '../../sections/@dashboard/user/user-all'

// ----------------------------------------------------------------------

const TABLE_HEAD = [
  { id: 'name', label: 'Email', align: 'left' },
  { id: 'author', label: 'Họ tên', align: 'left' },
...
export default function UserAll() {
  ...
  return (
    <Page title="Người dùng: Tất cả">
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          heading="Quản lý người dùng"
          links={[
            { name: 'Bảng điều khiển', href: PATH_DASHBOARD.root },
            { name: 'Người dùng', href: PATH_DASHBOARD.userCustom.root },
            { name: 'Tất cả', href: PATH_DASHBOARD.userCustom.all },
          ]}
          action={
            <Button
              variant="contained"
              ...
              to={PATH_DASHBOARD.userCustom.new}>
              Người dùng mới
            </Button>
          }
        />
